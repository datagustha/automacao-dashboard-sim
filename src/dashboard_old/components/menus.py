    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    ...
                    dcc.Link(
                        [
                            DashIconify(
                                icon="lucide:dollar-sign", width=20, className="me-3"
                            ),
                            "Pagamentos",
                        ],
                        href="/pagamentos",
                    ...
                    dcc.Link(
                        [
                            DashIconify(
                                icon="lucide:users", width=20, className="me-3"
                            ),
                            "Operadores",
                        ],
                        href="/operadores",
            ...
            html.Div(
                dbc.Button(
                    [
                        DashIconify(icon="lucide:log-out", width=18, className="me-2"),
                        "Sair do Sistema",
                    ],
                    id="logout-button",
                    color="light",
...
def get_header(
    ...
    if imagem_url:
        ...
        avatar = DashIconify(
            icon="lucide:user-circle", width=45, color="var(--purple-main)"
        )
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Small(
                                    "Administrador" if perfil == "adm" else "Operador",
                                    className="text-muted d-block text-end me-2",
                                ),
