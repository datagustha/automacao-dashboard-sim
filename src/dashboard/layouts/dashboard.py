...
🔧 CORREÇÕES APLICADAS:
  1. Tabela de performance agora usa container_tabela_ranking com fixed_cols=3
  2. fixed_columns removido da tabela de evolução (causava erro)
  3. Todas as DataTables com columns=[] e data=[]
  4. Try/except no layout
"""
...
from src.dashboard.components.graficos import (
    grafico_barras_fase,
...
def get_dashboard_layout(
    ...
    try:
            ...
            [
                            ...
                            [
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.Span(
                                            "Pesquisando...", style={"fontSize": "11px"}
                                        ),
                                    ],
                                    style={
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            criar_filtro_data_range(""), width=12, md=5, className="mb-3"
                        ),
                    ],
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " — passe o mouse nos cards para entender cada indicador",
                                    style={
                                        "fontSize": "11px",
                                        "color": "#aaa",
                                        "marginLeft": "8px",
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dcc.Loading(
                                type="circle",
                                children=grafico_evolucao_diaria(
                                    "grafico-faturamento",
                                    "Evolução Diária - Faturamento no Período",
                                ),
                            ),
                            width=12,
                            md=col_evolucao_width,
                        ),
                        # Gráfico de fase: para AGORACRED fica oculto
                        dbc.Col(
                            dcc.Loading(
                                type="circle",
                                children=grafico_barras_fase(
                                    "grafico-fase", "Pagamentos por Fase", cor="roxo"
                                ),
                            ),
                            width=12,
                            md=6,
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dcc.Loading(
                                type="circle",
                                children=container_tabela_ranking(
                        ...
                        dcc.Loading(
                            ...
                            children=[
                                ...
                                dash_table.DataTable(
                                    ...
                                    page_size=15,
                                    sort_action="native",
                                    # fixed_columns REMOVIDO - causava erro
                                    style_table={
                                        "overflowX": "auto",
                                        "borderRadius": "8px",
                                        "minWidth": "100%",
                ...
                dcc.Interval(
                    id="intervalo-atualizacao", interval=300 * 1000, n_intervals=0
                ),
            ],
        ...
        print(f"[DASHBOARD] ❌ Erro ao construir layout: {str(e)}")
        import traceback
        traceback.print_exc()
        ...
        return html.Div(
            [
                html.H2("❌ Erro ao carregar Dashboard", style={"color": "red", "padding": "20px"}),
                html.P(f"Detalhes: {str(e)}", style={"padding": "0 20px"}),
                html.A("Voltar ao Login", href="/", className="btn btn-primary", style={"margin": "20px"})
            ],
