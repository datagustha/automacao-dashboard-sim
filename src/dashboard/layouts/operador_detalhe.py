...
def get_operador_detalhe_layout(nome_usuario: str, imagem_url: str = None, operador_selecionado: dict = None, banco: str = "SEMEAR", is_adm: bool = False):
                    ...
                    children=[
                        dash_table.DataTable(
                            ...
                            columns=[
                                ...
                                {"name": "Dia Útil", "id": "dia_util", "type": "numeric"},
                                {"name": "Data", "id": "data", "type": "text"},
                                {"name": "Quantidade", "id": "quantidade", "type": "numeric"},
                                {"name": "Faturamento", "id": "faturamento", "type": "text"},
                                {"name": "Meta Diária", "id": "meta_diaria", "type": "text"},
                                {"name": "Bateu Meta?", "id": "bateu_meta", "type": "text"},
                            ],
                            page_size=32,
                            sort_action="native",
                    ...
                    children=[
                        dash_table.DataTable(
                            ...
                            columns=[
                                ...
                                {"name": "Faturamento Total", "id": "faturamento", "type": "text"},
                            ],
                            page_size=6,
                            sort_action="native",
                            style_table={"overflowX": "auto", "borderRadius": "8px"},
    ...
    titulo_header = "📊 Desempenho - SEMEAR - AGORACRED" if is_adm else f"📊 Desempenho - {banco}"
    # Obtem a data de admissao do operador visualizado para exibir no header (se fornecido)
    admissao_header = operador_selecionado.get('admissao') if operador_selecionado else None
    
    conteudo = html.Div(
        [
            # Renderiza o header superior com o titulo adaptado, a admissao e o perfil correto do usuario logado/visualizado
            get_header(nome_operador, imagem_operador, titulo_header, admissao=admissao_header, perfil="adm" if is_adm else "operador"),
